...
class juego{
  ...
  void PanSeleccion(){
    ...
    fill(0);
    textSize(20);
    text(" Z/1          X/2          C/3           V/4         B/5",30,310);
    ...
    if(this.jugador1 && this.jugador2){
      text("Okay! => K para pelear",250,400);
    }
  ...
  void PanGanador(){
    ...
    textSize(50);
    if(P1.vida > P2.vida){
      text("Jugador 1 gana",70,280);
      DisplayP1();
      translate(125,300);
      Corona();
    }
    else{
      text("Jugador 2 gana",70,280);
      DisplayP2();
      translate(323,300);
      Corona();
    }
    ...
    fill(#080808);
    textSize(20);
    text("Pulsa R para reiniciar",-30,150);
